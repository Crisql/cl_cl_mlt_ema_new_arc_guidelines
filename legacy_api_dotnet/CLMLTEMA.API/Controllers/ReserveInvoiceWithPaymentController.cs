...
namespace CLMLTEMA.API.Controllers
{
    ...
    public class ReserveInvoiceWithPaymentController: ApiController
    {
        
        /// <summary>
        /// Handles the POST request to create a reserve invoice with payment.
        /// </summary>
        /// <returns>HTTP response message indicating the status of the operation.</returns>
        public async Task<HttpResponseMessage> Post()
        {
            try
            {
                ...
                CLContext<ARInvoiceWithPayment> oCLContext = await Process.PostReserveInvoicesWithPayment(document, attachment, attachmentFiles);
