...
export class PurchaseSearchDocsResolver implements Resolve<ISearchPurchaseDocumentsResolvedData | null> {


  constructor(
    private salesPersonsService: SalesPersonService,
    private businessPartnerService: SuppliersService,
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<ISearchPurchaseDocumentsResolvedData | null> {
    return forkJoin({
